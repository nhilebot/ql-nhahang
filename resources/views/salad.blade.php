...
<style>
    ...
    /* --- BANNER CSS (CHỐNG XUNG ĐỘT) --- */

/* Reset lại body để đảm bảo tràn viền tuyệt đối */
body {
    margin: 0;
    padding: 0;
}
...
@section('content')
<div class="container">
    <div class="menu-banner"> <img src="{{ asset('images/bannersl.jpg') }}" alt="Banner Hải Sản" class="banner-img"> 
 </div>
<div class="container">
    <div class="row">
        <div class="col-xs-12">
