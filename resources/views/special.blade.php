...
<style>
    ...
    margin: 0;
    padding: 0;
    /* Ép trình duyệt không bao giờ hiện thanh cuộn ngang */
...
.menu-banner {
    ...
    position: relative;
    left: 50%;
    transform: translateX(-50%); /* Dùng transform thay cho margin-left để chính xác hơn */
    height: 600px;
    background-color: #000; /* Nền đen để nếu ảnh load chậm cũng không thấy vệt trắng */
    overflow: hidden;
}
...
<div class="menu-banner"> 
    <img src="{{ asset('images/breakfast.jpg') }}" alt="Banner Hải Sản" class="banner-img"> 
</div>
<div class="container">
    <div class="row">
        <div class="col-xs-12">
